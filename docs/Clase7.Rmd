...
resumenSex$term[1] <- "Hembra"
resumenSex$term[2] <- "Macho"
...
resumenTactic$term[1] <- "fem"
resumenTactic$term[2] <- "sneak"
resumenTactic$term[3] <- "terr"
